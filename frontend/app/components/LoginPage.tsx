    ...
    <div className="relative z-10 w-full min-h-screen flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        {activeTab === 'signin' && (
          ...
          >
            <div>
              <label className="mb-2 block" style={{ fontWeight: 200 }}>Email</label>
              <input
                type="email"
            ...
            <div>
              <label className="mb-2 block" style={{ fontWeight: 200 }}>Password</label>
              <input
                type="password"
                placeholder="••••••••"
                className="w-full px-4 py-3 glass-nested rounded-lg outline-none focus:ring-2 focus:ring-[#0066FF] focus:ring-opacity-30 transition-all"
            ...
            <button
              ...
              className="btn-micro mt-6 w-full rounded-[var(--radius-lg)] py-3 text-white"
              style={{
                background: '#0066FF',
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-4" style={{ background: 'var(--glass-bg)', fontWeight: 200, color: '#6B6B6B' }}>or</span>
              </div>
            </div>
            ...
            <button
              type="button"
              onClick={onAuthSuccess}
              className="btn-micro flex w-full items-center justify-center gap-2 rounded-[var(--radius-lg)] py-3 glass-nested"
            >
        ...
        {activeTab === 'signup' && (
          ...
          >
            ...
            <div>
              <label className="mb-2 block" style={{ fontWeight: 200 }}>Confirm Password</label>
              <input
                type="password"
                placeholder="••••••••"
                className="w-full px-4 py-3 glass-nested rounded-lg outline-none focus:ring-2 focus:ring-[#0066FF] focus:ring-opacity-30 transition-all"
